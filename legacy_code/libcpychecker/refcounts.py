...
from legacy_code.libcpychecker.absinterp import *
from legacy_code.libcpychecker.attributes import fnnames_returning_borrowed_refs, \
    stolen_refs_by_fnname, fnnames_setting_exception, \
    fnnames_setting_exception_on_negative_result
from legacy_code.libcpychecker.diagnostics import Reporter, Annotator, Note
from legacy_code.libcpychecker.PyArg_ParseTuple import PyArgParseFmt, FormatStringWarning,\
    TypeCheckCheckerType, TypeCheckResultType, \
    ConverterCallbackType, ConverterResultType
from legacy_code.libcpychecker.Py_BuildValue import PyBuildValueFmt, ObjectFormatUnit, \
    CodeSO, CodeN
from legacy_code.libcpychecker.types import is_py3k, is_debug_build, get_PyObjectPtr, \
    get_Py_ssize_t
from legacy_code.libcpychecker.utils import log
from legacy_code.libcpychecker import compat
...
from legacy_code.libcpychecker.initializers import get_all_PyTypeObject_initializers
...
def emit_refcount_warning(msg,
    ...
    if 1:
        ...
        # Debug help:
        from legacy_code.libcpychecker.diagnostics import TestAnnotator
...
def check_refcounts(fun, dump_traces=False, show_traces=False,
    ...
    if show_traces:
        from legacy_code.libcpychecker.visualizations import StateGraphPrettyPrinter
    ...
    if rep.got_warnings():
        ...
        from legacy_code.libcpychecker_html.make_html import HtmlPage
