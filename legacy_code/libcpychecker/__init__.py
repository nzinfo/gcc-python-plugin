...
import sys
import gcc
from legacy_code.libcpychecker.formatstrings import check_pyargs
from legacy_code.libcpychecker.utils import log
from legacy_code.libcpychecker.refcounts import check_refcounts
from legacy_code.libcpychecker.attributes import register_our_attributes
from legacy_code.libcpychecker.initializers import check_initializers
from legacy_code.libcpychecker.types import get_PyObject
if hasattr(gcc, 'PLUGIN_FINISH_DECL'):
    from legacy_code.libcpychecker.compat import on_finish_decl
