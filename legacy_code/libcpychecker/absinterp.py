...
from legacy_code.libcpychecker.utils import log, logging_enabled
from legacy_code.libcpychecker.types import *
from legacy_code.libcpychecker.diagnostics import location_as_json, type_as_json
...
class State(object):
    ...
    def var_region(self, var):
        ...
        if var not in self.region_for_var:
            ...
            if str(var.type) == 'struct PyObject':
                from legacy_code.libcpychecker.refcounts import RefcountValue
    ...
    def apply_fncall_side_effects(self, transitions, stmt):
        ...
        # arguments:
        from legacy_code.libcpychecker.attributes import stolen_refs_by_fnname
        ...
        # exception state:
        from legacy_code.libcpychecker.attributes import fnnames_setting_exception
        ...
        from legacy_code.libcpychecker.attributes import fnnames_setting_exception_on_negative_result
